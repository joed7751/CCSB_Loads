...
Sand_Rumsey<-importRDB("Sand_RumseyR.txt")
...
title(main = "11451800_Sand Response_m1 vs Fitted Values",xlab = "Fitted Values",ylab = "Response Values")
plot(Sand_Rumseym1,which = 2,set.up = F)
title(main = "11451800_Sand_m1 Residuals vs Fitted Values")
plot(Sand_Rumseym1,which = 3,set.up = F)
title(main = "11451800_Sand_m1 Assessing Heteroscedasticity") #Add "of Residuals"?
plot(Sand_Rumseym1,which = 4,set.up = F)
title(main = "11451800_Sand_m1 Correlogram of Samples")
plot(Sand_Rumseym1,which = 5,set.up = F)
title(main="11451800_Sand_m1 Normal Discharge")
plot(Sand_Rumseym1,which = 6,set.up = F)
title(main="11451800_Sand_m1 Box Plot of Loads")
...
write.csv(Sand_Rumsey_load,"1_Rumsey_Sand_m1_Flux_Annual.csv")
Sand_Rumsey_load_day<-predLoad(Sand_Rumseym1, RumseyQ,load.units = "kg",by="day",allow.incomplete = TRUE,conf.int = 0.90,print = TRUE)
write.csv(Sand_Rumsey_load_day,"1_Rumsey_Sand_m1_Flux_Daily.csv")
