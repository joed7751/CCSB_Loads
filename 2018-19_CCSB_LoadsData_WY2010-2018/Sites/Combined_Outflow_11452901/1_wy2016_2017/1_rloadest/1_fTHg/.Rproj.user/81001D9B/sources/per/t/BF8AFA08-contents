...
plot(fTHg_Combinedm5,ann=FALSE)
title(main = "11452901_fTHg Response vs Fitted Values",xlab = "Fitted Values",ylab = "Response Values")
plot(fTHg_Combinedm5,which = 2,set.up = F)
title(main = "11452901_fTHg Residuals vs Fitted Values")
plot(fTHg_Combinedm5,which = 3,set.up = F)
title(main = "11452901_fTHg Assessing Heteroscedasticity") #Add "of Residuals"?
plot(fTHg_Combinedm5,which = 4,set.up = F)
title(main = "11452901_fTHg Correlogram of Samples")
plot(fTHg_Combinedm5,which = 5,set.up = F)
title(main="11452901_fTHg Normal Discharge")
plot(fTHg_Combinedm5,which = 6,set.up = F)
title(main="11452901_fTHg Box Plot of Loads")
...
fTHg_Combined_load<-predLoad(fTHg_Combinedm5,CombinedQ,load.units="kg",by="water year",allow.incomplete = TRUE,conf.int = 0.95,print = TRUE)
write.csv(fTHg_Combined_load,"1_Combined_fTHg_m5_Flux_Annual.csv")
fTHg_Combined_load_day<-predLoad(fTHg_Combinedm5, CombinedQ,load.units = "kg",by="day",allow.incomplete = TRUE,conf.int = 0.90,print = TRUE)
write.csv(fTHg_Combined_load_day,"1_Combined_fTHg_m5_Flux_Daily.csv")
