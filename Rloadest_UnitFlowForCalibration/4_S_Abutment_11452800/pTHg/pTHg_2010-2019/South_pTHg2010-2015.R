...
pTHg_South <- importRDB("South_pTHg_2010-2015.txt")
pTHg_South
### Reading in Flow Data
SouthQ <- importRDB("SouthQDaily_2010_2015.txt")
...
preds_conc_lr5
exportCSV(preds_conc_lr5, file.name = "South_pTHg_conc_lr5_2010-2015.cvs")
...
preds_Flux_lr5day
exportCSV(preds_Flux_lr5day, file.name = "South_pTHgFlux_lr5_Day2010-2015.cvs")
...
preds_Flux_lr5WY
exportCSV(preds_Flux_lr5WY, file.name = "South_pTHg_Flux_lr5_WY2010-2015.cvs")
