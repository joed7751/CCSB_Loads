...
pMeHg_Outlet_load<-predLoad(pMeHg_Outletm5,OutletQ,load.units="kg",by="water year",allow.incomplete = TRUE,conf.int = 0.95,print = TRUE)
write.csv(pMeHg_Outlet_load,"1_Outflow_pMeHg_m5_Flux_Annual.csv")
pMeHg_Outlet_load_day<-predLoad(pMeHg_Outletm5, OutletQ,load.units = "kg",by="day",allow.incomplete = TRUE,conf.int = 0.90,print = TRUE)
write.csv(pMeHg_Outlet_load_day,"1_Outflow_pMeHg_m5_Flux_Daily.csv")
