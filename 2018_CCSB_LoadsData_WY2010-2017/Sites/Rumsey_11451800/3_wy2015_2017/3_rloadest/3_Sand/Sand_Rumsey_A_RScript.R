...
Sand_Rumsey<-importRDB("Sand_RumseyR_A.txt")
...
plot(Sand_Rumseym3,ann=FALSE)
title(main = "11451800_A_Sand_m3 Response vs Fitted Values",xlab = "Fitted Values",ylab = "Response Values")
plot(Sand_Rumseym3,which = 2,set.up = F)
title(main = "11451800_A_Sand_m3 Residuals vs Fitted Values")
plot(Sand_Rumseym3,which = 3,set.up = F)
title(main = "11451800_A_Sand_m3 Assessing Heteroscedasticity") #Add "of Residuals"?
plot(Sand_Rumseym3,which = 4,set.up = F)
title(main = "11451800_A_Sand_m3 Correlogram of Samples")
plot(Sand_Rumseym3,which = 5,set.up = F)
title(main="11451800_A_Sand_m3 Normal Discharge")
plot(Sand_Rumseym3,which = 6,set.up = F)
title(main="11451800_A_Sand_m3 Box Plot of Loads")

#These functions plot the data using the chosen best model and add a title and labels to the plot.

Sand_Rumsey_load<-predLoad(Sand_Rumseym3,RumseyQ,load.units="kg",by="water year",allow.incomplete = TRUE,conf.int = 0.95,print = TRUE)
write.csv(Sand_Rumsey_load,"3_Rumsey_A_Sand_m3_Flux_Annual.csv")
Sand_Rumsey_load_day<-predLoad(Sand_Rumseym3, RumseyQ,load.units = "kg",by="day",allow.incomplete = TRUE,conf.int = 0.90,print = TRUE)
write.csv(Sand_Rumsey_load_day,"3_Rumsey_A_Sand_m3_Flux_Daily.csv")
