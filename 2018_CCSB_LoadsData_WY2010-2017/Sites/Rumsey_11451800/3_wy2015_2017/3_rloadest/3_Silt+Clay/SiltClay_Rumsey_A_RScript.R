...
title(main = "11451800_A_Silt+Clay_m1 Response vs Fitted Values",xlab = "Fitted Values",ylab = "Response Values")
plot(SiltClay_Rumseym1,which = 2,set.up = F)
title(main = "11451800_A_Silt+Clay_m1 Residuals vs Fitted Values")
plot(SiltClay_Rumseym1,which = 3,set.up = F)
title(main = "11451800_A_Silt+Clay_m1 Assessing Heteroscedasticity") #Add "of Residuals"?
plot(SiltClay_Rumseym1,which = 4,set.up = F)
title(main = "11451800_A_Silt+Clay_m1 Correlogram of Samples")
plot(SiltClay_Rumseym1,which = 5,set.up = F)
title(main="11451800_A_Silt+Clay_m1 Normal Discharge")
plot(SiltClay_Rumseym1,which = 6,set.up = F)
title(main="11451800_A_Silt+Clay_m1 Box Plot of Loads")
...
write.csv(SiltClay_Rumsey_load,"3_Rumsey_A_Silt+Clay_m1_Flux_Annual.csv")
...
write.csv(SiltClay_Rumsey_load_day,"3_Rumsey_A_Silt+Clay_m1_Flux_Daily.csv")
