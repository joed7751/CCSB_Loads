...
pTHg_Outlet<-importRDB("pTHg_OutletR.txt")  #Use this file when the best model has been selected. 
...
#print(pTHg_Outletm1,brief = FALSE, load.only = FALSE)
#print(pTHg_Outletm2,brief = FALSE, load.only = FALSE)
#print(pTHg_Outletm3,brief = FALSE, load.only = FALSE)
#print(pTHg_Outletm4,brief = FALSE, load.only = FALSE)
#print(pTHg_Outletm5,brief = FALSE, load.only = FALSE)
#print(pTHg_Outletm6,brief = FALSE, load.only = FALSE)
#print(pTHg_Outletm7,brief = FALSE, load.only = FALSE)
#print(pTHg_Outletm8,brief = FALSE, load.only = FALSE)
#print(pTHg_Outletm9,brief = FALSE, load.only = FALSE)
#Commenting these out. These provide some explanations of the data in a longer form. Brief results are printed to console (pTHg_Outletm1-9)

plot(pTHg_Outletm5,ann=FALSE)
title(main = "11452900_pTHg Response vs Fitted Values",xlab = "Fitted Values",ylab = "Response Values")
plot(pTHg_Outletm5,which = 2,set.up = F)
title(main = "11452900_pTHg Residuals vs Fitted Values")
plot(pTHg_Outletm5,which = 3,set.up = F)
title(main = "11452900_pTHg Assessing Heteroscedasticity") #Add "of Residuals"?
plot(pTHg_Outletm5,which = 4,set.up = F)
title(main = "11452900_pTHg Correlogram of Samples")
plot(pTHg_Outletm5,which = 5,set.up = F)
title(main="11452900_pTHg Normal Discharge")
plot(pTHg_Outletm5,which = 6,set.up = F)
title(main="11452900_pTHg Box Plot of Loads")
