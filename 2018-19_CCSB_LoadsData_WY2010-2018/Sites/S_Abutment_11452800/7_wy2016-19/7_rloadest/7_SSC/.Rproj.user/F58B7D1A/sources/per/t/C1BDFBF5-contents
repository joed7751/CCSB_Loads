...
plot(SSC_SAbutmentm1,ann=FALSE)
title(main = "7_11452800_SSC_m1 Response vs Fitted Values",xlab = "Fitted Values",ylab = "Response Values")
plot(SSC_SAbutmentm1,which = 2,set.up = F)
title(main = "7_11452800_SSC_m1 Residuals vs Fitted Values")
plot(SSC_SAbutmentm1,which = 3,set.up = F)
title(main = "7_11452800_SSC_m1 Assessing Heteroscedasticity") 
plot(SSC_SAbutmentm1,which = 4,set.up = F)
title(main = "7_11452800_SSC_m1 Correlogram of Samples")
plot(SSC_SAbutmentm1,which = 5,set.up = F)
title(main="7_11452800_SSC_m1 Normal Discharge")
plot(SSC_SAbutmentm1,which = 6,set.up = F)
title(main="7_11452800_SSC_m1 Box Plot of Loads")

#These functions plot the data using the chosen best model and add a title and labels to the plot.

SSC_SAbutment_load<-predLoad(SSC_SAbutmentm1,S_AbutmentQ,load.units="kg",by="water year",allow.incomplete = TRUE,conf.int = 0.95,print = TRUE)
write.csv(SSC_SAbutment_load,"7_S_Abutment_SSC_m1_Flux_Annual.csv")
SSC_SAbutment_load_day<-predLoad(SSC_SAbutmentm1, S_AbutmentQ,load.units = "kg",by="day",allow.incomplete = TRUE,conf.int = 0.90,print = TRUE)
write.csv(SSC_SAbutment_load_day,"7_S_Abutment_SSC_m1_Flux_Daily.csv")
