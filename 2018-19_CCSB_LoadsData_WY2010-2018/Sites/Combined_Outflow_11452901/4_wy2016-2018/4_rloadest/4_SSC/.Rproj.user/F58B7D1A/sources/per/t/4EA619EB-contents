...
title(main = "4_114525901_SSC_m3 Response vs Fitted Values",xlab = "Fitted Values",ylab = "Response Values")
plot(SSC_Combinedm3,which = 2,set.up = F)
title(main = "4_114525901_SSC_m3 Residuals vs Fitted Values")
plot(SSC_Combinedm3,which = 3,set.up = F)
title(main = "4_114525901_SSC_m3 Assessing Heteroscedasticity") 
plot(SSC_Combinedm3,which = 4,set.up = F)
title(main = "4_114525901_SSC_m3 Correlogram of Samples")
plot(SSC_Combinedm3,which = 5,set.up = F)
title(main="4_114525901_SSC_m3 Normal Discharge")
plot(SSC_Combinedm3,which = 6,set.up = F)
title(main="4_114525901_SSC_m3 Box Plot of Loads")
...
write.csv(SSC_Combined_load,"4_Combined_SSC_m3_Flux_Annual.csv")
...
write.csv(SSC_Combined_load_day,"4_Combined_SSC_m3_Flux_Daily.csv")
