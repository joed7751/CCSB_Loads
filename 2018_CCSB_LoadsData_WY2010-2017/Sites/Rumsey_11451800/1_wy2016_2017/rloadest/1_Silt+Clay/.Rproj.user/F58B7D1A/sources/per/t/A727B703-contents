#SiltClay Rumsey script for retrieving loads models stats (the stats are used to select the best model for this constituent at this site) and loads predictions.
...
SiltClay_Rumsey<-importRDB("SiltClay_RumseyR.txt")
...
title(main = "11451800_Silt+Clay_m3 Response vs Fitted Values",xlab = "Fitted Values",ylab = "Response Values")
plot(SiltClay_Rumseym3,which = 2,set.up = F)
title(main = "11451800_Silt+Clay_m3 Residuals vs Fitted Values")
plot(SiltClay_Rumseym3,which = 3,set.up = F)
title(main = "11451800_Silt+Clay_m3 Assessing Heteroscedasticity") #Add "of Residuals"?
plot(SiltClay_Rumseym3,which = 4,set.up = F)
title(main = "11451800_Silt+Clay_m3 Correlogram of Samples")
plot(SiltClay_Rumseym3,which = 5,set.up = F)
title(main="11451800_Silt+Clay_m3 Normal Discharge")
plot(SiltClay_Rumseym3,which = 6,set.up = F)
title(main="11451800_Silt+Clay_m3 Box Plot of Loads")
...
write.csv(SiltClay_Rumsey_load,"1_Rumsey_Silt+Clay_m3_Flux_Annual.csv")
...
write.csv(SiltClay_Rumsey_load_day,"1_Rumsey_Silt+Clay_m3_Flux_Daily.csv")
